...
.. 
    contains detailed information for users about the package, installation steps
    basic usage, instructions and links to other resources such as documentation